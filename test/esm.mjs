...
console.log(new Date('2022-09-25 14:30:00.023').format('YY-M-D N hm:m:s.CC'));
console.log(
  new Date('2022-09-25 14:30:00.023').format('YYYY / DDD / sssss / CCC')
);
...
console.log(
  new Date('2022-01-02 00:00:00').compare(new Date('2022-01-01 23:53:00'))
);
console.log(
  new Date('2022-01-02 00:00:00.000').compare(
    new Date('2022-01-01 23:59:59.256')
  )
);
